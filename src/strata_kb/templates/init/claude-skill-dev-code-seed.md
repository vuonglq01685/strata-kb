---
name: dev-code-seed
description: Bootstrap curated service knowledge for a repo adopting strata-kb — extract structure, let the LLM draft each service's responsibility from code evidence, correct it, approve it, and publish. One-time per repo. Use when onboarding a project into the KB, or when invoked as /dev-code-seed.
---
