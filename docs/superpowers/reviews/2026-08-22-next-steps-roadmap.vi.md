...
- [x] **B4 — Nối vào handover** (gom vào ĐỢT TEMPLATE CHUNG)
...
- [x] **C4 — Kỷ luật budget cho kb_search** (skill text — ĐỢT TEMPLATE CHUNG)
...
>
> - **C5 chỉ làm freshness block** (952 → 605 ký tự, −36%). Phần gộp 14 hard
